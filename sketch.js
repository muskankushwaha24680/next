...
rope1 = new Rope(bob1.body,{x: 300, y: 90});
rope2 = new Rope(bob2.body,{x: 360,y: 90 });
rope3 = new Rope(bob3.body,{x: 420 , y: 90});
rope4 = new Rope(bob4.body,{x: 480 , y: 90});
rope5 = new Rope(bob5.body,{ x: 540, y: 90});
